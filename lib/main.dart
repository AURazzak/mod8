...
class _MyHomePageState extends State<MyHomePage> {
  List cartList = [
    ...
    {
      "img":
      "https://catchmydrift.in/cdn/shop/products/real-girls-have-muscles-special-black-t-shirt-for-women-printrove-119473.jpg?v=1674877618&width=493",
      "title": "T-Shirt",
      "color": "Gray",
      "Size": "L",
      "Price": "30",
    ...
    {
      "img":
      "https://ng.jumia.is/unsafe/fit-in/680x680/filters:fill(white)/product/77/8037921/1.jpg?7909",
      "title": "Sport dress",
      "color": "Black",
      "Size": "M",
      "Price": "43",
                                        ...
                                        onTap: () {
                                          setState(() {
                                            if (cartList[index]["count"] > 0) {
                                              ...
                                              totalAmount -= int.parse(cartList[index]["Price"]);
                                            }
                                          });
                                        },
